...
public class CofferTextBlank extends JPanel {
	...
	public CofferTextBlank(String placeHolder, String text) {
		...
		textField.addKeyListener(new KeyAdapter(){
			...
			public void keyTyped(KeyEvent arg0) { 
				for(CofferTextBlankEditListener listener : listeners ){ listener.onValueChange(); }
			}
	...
	public void reset(){ textField.setText( defaultText ); }
	
	public void setWidth(int width){ this.width = width; }
	
	public void setEditable(boolean flag){ textField.setEditable(flag); }
	...
	public void addCofferTextBlankEditListener(CofferTextBlankEditListener ctbel){ listeners.add(ctbel); }
