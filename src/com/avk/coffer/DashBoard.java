...
public class DashBoard extends JPanel {
	...
	private static CofferTabLabel allPasswordsTab, addPasswordTab, generatePasswordTab, helpTab, aboutTab;
	...
	public DashBoard() {
		...
		helpTab = new CofferTabLabel("Help", CofferReferences.SINGLE_KEY);
		helpTab.setBounds(0, pageHeight - 80, 200, 40);
		tabsDisplay.add(helpTab);
		tabs.put(help_page, helpTab );
		...
		if(shouldCreateNew){
			switch(page){
				case all_passwords_page:{
					displayPanel.add(new AllPasswordsPage(),page); break;			
				}
				case add_entry_page:{
					displayPanel.add(new AddEntryPage(),page); break;
				}
				case password_generator_page:{
					displayPanel.add(new PasswordGeneratorPage(),page); break;
				}
			}			
		}
