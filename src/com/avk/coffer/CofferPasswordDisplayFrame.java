...
public class CofferPasswordDisplayFrame extends JDialog {
			...
			public void onToggle() {
				if(editSwitch.isOn()){
					...
					if(anyBlankEdited){
						...
						{
							if(titleEdited) titleBlank.reset();
							if(urlEdited) urlBlank.reset();
							if(usernameEdited) usernameBlank.reset();
							if(passwordEdited){ 
								passwordBlank.reset(); 
	...
	protected void setStatus(String string) { lblStatus.setText(string); }
	
	protected String getStatus(){ return lblStatus.getText(); }
}
